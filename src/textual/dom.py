...
class DOMNode(MessagePump):
    ...
    def query(
        ...
        """Query the DOM for children that match a selector or selector type.
    ...
    def query_one(
        ...
        """Get a single widget from this widget's children that matches a selector or selector type.
