...
DefaultEasingFunctions = Literal["none", "round", "linear", "in_sine", "in_out_sine", "out_sine", "in_quad", "in_out_quad", "out_quad", "in_cubic", "in_out_cubic", "out_cubic", "in_quart", "in_out_quart", "out_quart", "in_quint", "in_out_quint", "out_quint", "in_expo", "in_out_expo", "out_expo", "in_circ", "in_out_circ", "out_circ", "in_back", "in_out_back", "out_back", "in_elastic", "in_out_elastic", "out_elastic", "in_bounce", "in_out_bounce", "out_bounce"]
