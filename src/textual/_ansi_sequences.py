...
ANSI_SEQUENCES_KEYS: Mapping[str, Tuple[Keys, ...]] = {
    ...
    "\x1b[24;2~": (Keys.F24,),
    # Meta + Function keys.
    "\x1b[1;3P": (Keys.Escape, Keys.F1),
    "\x1b[1;3Q": (Keys.Escape, Keys.F2),
    "\x1b[1;3R": (Keys.Escape, Keys.F3),
    "\x1b[1;3S": (Keys.Escape, Keys.F4),
    "\x1b[15;3~": (Keys.Escape, Keys.F5),
    "\x1b[17;3~": (Keys.Escape, Keys.F6),
    "\x1b[18;3~": (Keys.Escape, Keys.F7),
    "\x1b[19;3~": (Keys.Escape, Keys.F8),
    "\x1b[20;3~": (Keys.Escape, Keys.F9),
