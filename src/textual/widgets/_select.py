...
class Select(Generic[SelectType], Vertical, can_focus=True):
    ...
    def from_values(
        ...
        *,
        ...
        """Initialize the Select control with options specified by an iterable of
        of any type (string, integer, etc.).  The string representation in the
        control is generated by this method using the built-in str().
        ...
        Args:
         ...
         disabled: Whether the control is disabled or not.
        """
        options_iterator = [(str(o), o) for o in options]
