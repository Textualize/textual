...
"""
    ...
    def select_all(self) -> None:
        """Select all of the text in the `TextEditor`."""
...
class Edit:
    ...
    def do(self, text_editor: TextEditor) -> EditResult:
    ...
    def undo(self, text_editor: TextEditor) -> EditResult:
    ...
    def after(self, text_editor: TextEditor) -> None:
...
class Undoable(Protocol):
    ...
    To perform an edit operation, pass the Edit to `TextEditor.edit()`"""

    def do(self, text_editor: TextEditor) -> Any:
        """Do the action.

        Args:
            The `TextEditor` to perform the action on.

        Returns:
            Anything. This protocol doesn't prescribe what is returned.
        """

    def undo(self, text_editor: TextEditor) -> Any:
        """Undo the action.
