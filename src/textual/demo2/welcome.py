...
Message passing allows widgets to be entirely self contained.
...
Textual apps make be pip installed, via tools such as `pipx` or `uvx`, and other package manager.
